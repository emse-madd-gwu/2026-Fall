...
- Ask it what a `.qmd` file does, how it is different from a plain `.R` script, and for a quick demonstration of each. Ask it to put the demonstration files in the `hw1` folder.
...
In your course repo, open the file `hw1/reflection.qmd` and write at least a paragraph reflecting on your experiences from this assignment. Some prompts you could use:
