...
## `r fa('globe')` Course website: https://madd.seas.gwu.edu/2026-Fall/

--

## `r fa('slack')` Course slack: https://emse-madd-f26.slack.com

--

## `r fa('r-project')` & RStudio: [Course Software Page](https://madd.seas.gwu.edu/2026-Fall/software.html)
...
## `r fa('slack')` Use [Slack](https://emse-madd-f26.slack.com/) to ask questions.
