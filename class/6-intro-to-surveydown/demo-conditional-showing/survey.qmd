...
::: {.callout-note}
The `sd_value()` function automatically converts numeric-looking values to numbers, so you can compare them directly, e.g. `sd_value("car_number") > 1`.
:::
...
## This is the end of the demo of the conditional showing feature.
