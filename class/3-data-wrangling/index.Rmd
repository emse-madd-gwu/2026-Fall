...
The `file.path()` function builds the path to your **root** to your _working directory_ <br>(this is where your `.Rproj` file lives!)
...
The `file.path()` function builds the path to files _inside_ your working directory
