...
![](https://github.com/emse-madd-gwu/2026-Fall/raw/main/images/quiz_doge.png){width="400"}
:::
...
<center>
<img src="images/spreadsheet.png" width=900>
</center>
...
(Don't believe me? Read [this paper](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1008984))
...
<center>
<img src="images/data-wrangle.png" width="1200">
</center>
...
```{r}
beatles %>%
  mutate(playsGuitar = ifelse(instrument == "guitar", 1, 0))
```
...
# Product Attributes Table ([example](https://docs.google.com/spreadsheets/d/1G1GXamcurUJr3BclGmAzX2Ih2eeGN3920Z3WDq1zfrE/edit?usp=sharing))
...
4. Start building out your model relationships table (copy from [this example](https://docs.google.com/spreadsheets/d/1G1GXamcurUJr3BclGmAzX2Ih2eeGN3920Z3WDq1zfrE/edit?usp=sharing))
...
Sign up [here](https://calendar.app.google/niXopBudj9t4pmbj7) for your team proposal 1-on-1 with Prof. Helveston
