...
agenda_items <- c(
  'Computing "Willingness to Pay" (WTP)',
  "Incorporating Uncertainty via Simulation",
  "Directly Estimating WTP",
...
# [Computing WTP with draws]{.center}

## $$\hat{\boldsymbol{\omega}} = \frac{\hat{\boldsymbol{\beta}}}{-\hat{\alpha}}$$

::: {.col .fragment width="55%"}
...
# [Computing WTP from an estimated model]{.center}
...
# [Simulating Market Shares with Uncertainty]{.center}
