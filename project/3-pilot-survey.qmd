...
Your team's repo (`madd-f26/madd-team-<letter>`) already has a `3-pilot-survey/` folder seeded with the [choice-based conjoint survey template](https://github.com/surveydown-dev/template_conjoint_buttons) for your pilot survey. Open your team repo in Positron (**File > Open Folder...**). The folder contains the following files:
