...
Your team's repo (`madd-f26/madd-team-<letter>`) already has a `1-proposal/` folder seeded with a `proposal.qmd` starter file -- open your team repo in Positron (**File > Open Folder...**) and write your proposal there. The starter comes with some text and code explaining how to use it - you should delete this code / text as it is only for explanatory purposes. Be sure to adjust the content in the header:
