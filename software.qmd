...
7. **Install course R packages**: Download [this R file](./content/packages.R), then open it in Positron and run the code in the file in the R console (if you can't find it, go to "View" -> "Console" from the menu bar). This will install all the packages listed in the file.
