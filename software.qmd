...
> **Optional:** Posit has a new IDE called Positron, which is similar to RStudio but has some new features. I encourage you to try it out if you want, but it's not required for this course. You can download it [here](https://positron.posit.co/download.html).
